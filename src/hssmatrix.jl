...
for op in (:+,:-)
  @eval begin
    ...
    function $op(hssA::HssMatrix, hssB::HssMatrix, multithreaded::Bool=HssOptions().multithreaded)
      ...
      elseif isbranch(hssA) && isbranch(hssB)
        ...
        taskA11 = RecursionTools.spawn($op, (hssA.A11, hssB.A11), multithreaded)
        taskA22 = RecursionTools.spawn($op, (hssA.A22, hssB.A22), multithreaded)
